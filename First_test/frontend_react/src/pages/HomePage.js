        ...
        return (
            <>
                ...
                <Paper elevation={2} style={{
                    ...
                    <span style={{fontSize:'30px'}}>NUOVA EDIZIONE 2022-23!</span><br/>
                    <span>L'elenco delle classi dell'anno scolastico 2022-23 e le nuove adozioni dei libri di testo sono state aggiunte!</span>
                </Paper>
